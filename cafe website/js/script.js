            ...
            <div class="row justify-content-center">
              <div class="col-12 text-center footer-content">
                <div class="footer-title text-white">
                  <h1 class="fw-bold">SudikshaCafe.</h1>
                  <ul class="list-unstyled text-uppercase">
                    <li>open from 07:00 AM - 11:00 PM</li>
                    <li class="mb-3">Maharashtra NAVI MUMBAI</li>
                  </ul>
                  <span class="me-3"><i class="fa-brands fa-instagram"></i> Sudiksha Cafe</span>
                  <span><i class="fa-brands fa-whatsapp"></i>9167014970</span>
                </div>
              </div>
            </div>
            <div class="text-footer text-white text-center">
              <p class="m-0">
                Created with <i class="fa-solid fa-heart text-danger"></i> by <a href="https://www.instagram.com/_sweetyuiiee_/" target="_blank" class="text-warning">SudikshaRavale</a> © 2022 Copyright | All Rights Reserved
              </p>
            </div>
          </div>`;
}
